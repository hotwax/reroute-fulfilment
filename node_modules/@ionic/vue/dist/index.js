...
const hookNames = {
    [core.LIFECYCLE_WILL_ENTER]: LifecycleHooks.WillEnter,
    [core.LIFECYCLE_DID_ENTER]: LifecycleHooks.DidEnter,
    [core.LIFECYCLE_WILL_LEAVE]: LifecycleHooks.WillLeave,
    [core.LIFECYCLE_DID_LEAVE]: LifecycleHooks.DidLeave
};
const ids = { main: 0 };
...
const IonicVue = {
    async install(app, config = {}) {
        if (typeof window !== 'undefined') {
            ...
            core.setupConfig(Object.assign(Object.assign({}, config), { _ael: ael, _rel: rel }));
...
const IonBackButton = vue.defineComponent({
    name: 'IonBackButton',
    setup(_, { attrs, slots }) {
...
const IonPage = vue.defineComponent({
    name: 'IonPage',
    props: {
    ...
    setup(props, { attrs, slots }) {
        ...
        return () => {
            return vue.h('div', Object.assign(Object.assign({ ['class']: `ion-page ${hidePageClass}` }, attrs), { ref: 'ionPage' }), slots.default && slots.default());
        };
    }
});

let viewDepthKey = Symbol(0);
const IonRouterOutlet = vue.defineComponent({
    ...
    setup(_, { attrs }) {
         ...
         */
        vue.watch([route, matchedRouteRef], ([currentRoute, currentMatchedRouteRef], [_, previousMatchedRouteRef]) => {
            /**
        ...
        const handlePageTransition = async () => {
            ...
            fireLifecycle(enteringViewItem.vueComponent, enteringViewItem.vueComponentRef, core.LIFECYCLE_WILL_ENTER);
            if (leavingViewItem && enteringViewItem !== leavingViewItem) {
                let animationBuilder = routerAnimation;
                const leavingEl = leavingViewItem.ionPageElement;
                fireLifecycle(leavingViewItem.vueComponent, leavingViewItem.vueComponentRef, core.LIFECYCLE_WILL_LEAVE);
                /**
                * If we are going back from a page that
                * was presented using a custom animation
                * we should default to using that
                ...
                */
                ...
                fireLifecycle(leavingViewItem.vueComponent, leavingViewItem.vueComponentRef, core.LIFECYCLE_DID_LEAVE);
            }
            else {
                /**
            ...
            fireLifecycle(enteringViewItem.vueComponent, enteringViewItem.vueComponentRef, core.LIFECYCLE_DID_ENTER);
...
const IonTabButton = vue.defineComponent({
    name: 'IonTabButton',
    props: {
...
const IonTabs = vue.defineComponent({
    name: 'IonTabs',
    ...
    render() {
        ...
        let childrenToRender = [
            vue.h('div', {
                ...
                vue.h(IonRouterOutlet, { tabs: true })
            ])
        ];
        /**
...
const IonApp = vue.defineComponent({
    name: 'IonApp',
    setup(_, { attrs, slots }) {
        return () => {
...
const IonNav = vue.defineComponent({
    name: 'IonNav',
    setup() {
...
const IonIcon = vue.defineComponent({
    name: 'IonIcon',
    props: {
        ariaLabel: String,
        color: String,
...
const defineOverlayContainer = (name, componentProps = [], controller) => {
    ...
    const Container = vue.defineComponent((props, { slots, emit }) => {
...
const IonActionSheet = /*@__PURE__*/ defineOverlayContainer('ion-action-sheet', ['animated', 'backdropDismiss', 'buttons', 'cssClass', 'enterAnimation', 'header', 'keyboardClose', 'leaveAnimation', 'mode', 'subHeader', 'translucent'], core.actionSheetController);
const IonAlert = /*@__PURE__*/ defineOverlayContainer('ion-alert', ['animated', 'backdropDismiss', 'buttons', 'cssClass', 'enterAnimation', 'header', 'inputs', 'keyboardClose', 'leaveAnimation', 'message', 'mode', 'subHeader', 'translucent'], core.alertController);
const IonLoading = /*@__PURE__*/ defineOverlayContainer('ion-loading', ['animated', 'backdropDismiss', 'cssClass', 'duration', 'enterAnimation', 'keyboardClose', 'leaveAnimation', 'message', 'mode', 'showBackdrop', 'spinner', 'translucent'], core.loadingController);
const IonModal = /*@__PURE__*/ defineOverlayContainer('ion-modal', ['animated', 'backdropDismiss', 'component', 'componentProps', 'cssClass', 'enterAnimation', 'keyboardClose', 'leaveAnimation', 'mode', 'presentingElement', 'showBackdrop', 'swipeToClose'], core.modalController);
const IonPicker = /*@__PURE__*/ defineOverlayContainer('ion-picker', ['animated', 'backdropDismiss', 'buttons', 'columns', 'cssClass', 'duration', 'enterAnimation', 'keyboardClose', 'leaveAnimation', 'mode', 'showBackdrop'], core.pickerController);
const IonPopover = /*@__PURE__*/ defineOverlayContainer('ion-popover', ['animated', 'backdropDismiss', 'component', 'componentProps', 'cssClass', 'enterAnimation', 'event', 'keyboardClose', 'leaveAnimation', 'mode', 'showBackdrop', 'translucent'], core.popoverController);
const IonToast = /*@__PURE__*/ defineOverlayContainer('ion-toast', ['animated', 'buttons', 'color', 'cssClass', 'duration', 'enterAnimation', 'header', 'keyboardClose', 'leaveAnimation', 'message', 'mode', 'position', 'translucent'], core.toastController);
...
const useIonRouter = () => {
    const { canGoBack } = vue.inject('navManager');
    return {
        canGoBack
    };
};
...
const oldModalCreate = core.modalController.create.bind(core.modalController);
core.modalController.create = (options) => {
    return oldModalCreate(Object.assign(Object.assign({}, options), { delegate: VueDelegate() }));
};
const oldPopoverCreate = core.popoverController.create.bind(core.popoverController);
core.popoverController.create = (options) => {
...
Object.defineProperty(exports, 'actionSheetController', {
    enumerable: true,
    get: function () {
        return core.actionSheetController;
    }
});
Object.defineProperty(exports, 'alertController', {
    enumerable: true,
    get: function () {
        return core.alertController;
    }
});
...
Object.defineProperty(exports, 'getPlatforms', {
    enumerable: true,
    get: function () {
        return core.getPlatforms;
    }
});
Object.defineProperty(exports, 'getTimeGivenProgression', {
    enumerable: true,
    get: function () {
        return core.getTimeGivenProgression;
    }
});
...
Object.defineProperty(exports, 'isPlatform', {
    enumerable: true,
    get: function () {
        return core.isPlatform;
    }
});
Object.defineProperty(exports, 'loadingController', {
    enumerable: true,
    get: function () {
        return core.loadingController;
    }
});
...
Object.defineProperty(exports, 'menuController', {
    enumerable: true,
    get: function () {
        return core.menuController;
    }
});
Object.defineProperty(exports, 'modalController', {
    enumerable: true,
    get: function () {
        return core.modalController;
    }
});
Object.defineProperty(exports, 'pickerController', {
    enumerable: true,
    get: function () {
        return core.pickerController;
    }
});
Object.defineProperty(exports, 'popoverController', {
    enumerable: true,
    get: function () {
        return core.popoverController;
    }
});
Object.defineProperty(exports, 'toastController', {
    enumerable: true,
    get: function () {
        return core.toastController;
    }
});
