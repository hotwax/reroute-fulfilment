...
let Plugin;
console.warn(`[@intlify/vue-i18n-loader] IntlifyVuePlugin is experimental! This plugin is used for Intlify Devtools. Don't use this plugin to enhancement Component options of your application.`);
